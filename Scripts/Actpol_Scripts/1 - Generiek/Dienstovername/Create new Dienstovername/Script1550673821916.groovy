...
WebUI.setText(findTestObject('Actpol_Scripts/Generiek/Dienstovername/Journal'), 'testing', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Actpol_Scripts/Generiek/Dienstovername/j click'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Generiek/Dienstovername/Journal Journal set text'), 'Testing')
