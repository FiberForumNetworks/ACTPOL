...
String Assistentiexpath = ('//*[@name="actieselect" and @id="' + AssistentiedynamicId) + '"]'
...
WebUI.mouseOver(findTestObject('Actpol_Scripts/Generiek/Assistentie/Actie'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Generiek/Assistentie/Actie Wachtrapport'))
