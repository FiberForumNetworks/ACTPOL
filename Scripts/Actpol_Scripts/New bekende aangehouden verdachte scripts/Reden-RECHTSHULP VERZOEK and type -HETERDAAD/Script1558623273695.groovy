...
WebUI.setText(findTestObject('Actpol_Scripts/Generiek/Assistentie/Achternaam specific process'), 'ka')

WebUI.delay(3)

'Secting abdctest'
WebUI.click(findTestObject('Actpol_Scripts/Generiek/Assistentie/Achternaam specific process 18 lb'))
...
'select RECHTSHULP VERZOEK'
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Generiek/Assistentie/Reden'), '5', false)
