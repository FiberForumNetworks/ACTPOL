...
WebUI.setText(findTestObject('Actpol_Scripts/Generiek/Assistentie/Achternaam specific process'), 'AAA')

WebUI.delay(3)

'Secting abdctest'
WebUI.click(findTestObject('Actpol_Scripts/Generiek/Assistentie/Achternaam specific process 13 lb'))
...
'select I.V.M. VERDER ONDERZOEK'
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Generiek/Assistentie/Reden'), '2', false)

WebUI.delay(1)

'select HETERDAAD'
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Generiek/Assistentie/Type'), '2', false)
...
WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Fouillering ja'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Gebruik handboeien na'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Gebruik geweld ja'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Geweld Type-VERBAL WARNING'))
...
WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Aanhoudingslocatie'))

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Aanhoudingslocatie lb'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Locatienummer'), '12793')

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Nadere Aanduiding'), 'Testing')

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Aangehouden door 2'))

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Aangehouden door 2 lb'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Plaats van verhoor'))

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/New bekende aangehouden verdachte scripts/Plaats van verhoor lb'))
