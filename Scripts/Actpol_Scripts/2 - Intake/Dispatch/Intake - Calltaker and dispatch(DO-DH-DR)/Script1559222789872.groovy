...
WebUI.click(findTestObject('Actpol_Scripts/Intake/Calltaker/Adres van Incident lb 27'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Intake/Calltaker/Telefoon nummer'), '7788')
