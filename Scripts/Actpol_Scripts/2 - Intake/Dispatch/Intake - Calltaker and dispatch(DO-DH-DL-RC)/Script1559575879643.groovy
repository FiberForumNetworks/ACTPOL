...
WebUI.click(findTestObject('Actpol_Scripts/Intake/Calltaker/Adres van Incident lb 34'))
...
'RC'
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Extra script/Dispath Status'), '  ', false)
