...
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Intake/Calltaker/Status da'), 'CT', false)
...
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Intake/Calltaker/Status da'), 'TH', false)

WebUI.delay(1)

not_run: WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Intake/Calltaker/Status da'), '', false)
