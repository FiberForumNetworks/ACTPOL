...
String ArrestantenId = GlobalVariable.AssistentieID

String Assistentiexpath = ('//*[text()="' + ArrestantenId) + '"]/preceding-sibling::td/a[2]'

TestObject to = findTestObject('Actpol_Scripts/Opsporing/Arrestanten/user edit')
