...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/NIET BEKEND Achternaam'), 'ALBERG')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/A NIET BEKEND/NIET BEKEND Achternaam lb 2'))
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/A NIET BEKEND/NIET BEKEND Goederen Goed artikel lb 2'), FailureHandling.STOP_ON_FAILURE)
