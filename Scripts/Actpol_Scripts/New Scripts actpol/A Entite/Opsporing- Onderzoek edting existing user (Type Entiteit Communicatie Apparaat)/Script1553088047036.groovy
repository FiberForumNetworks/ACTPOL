...
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Opsporing/Onderzoek/Type Entiteit'), '11', false)
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/A Entite/Communicatie Apparaat/Communicatie Apparaat'))
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/A Entite/Communicatie Apparaat/Communicatie Apparaat save'))
