...
WebUI.comment('EIGEN WAARNEMING  start')
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/Verbalisant 1'), '23456')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/Verbalisant 2 lb'))
