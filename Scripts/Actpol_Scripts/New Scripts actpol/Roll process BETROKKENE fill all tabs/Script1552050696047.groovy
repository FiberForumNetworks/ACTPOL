...
WebUI.comment('BETROKKENE  start')
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/Contacten Achternaam'), 'kianie')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/A BETROKKENE/BETROKKENE Contacten Achternaam lb'))
