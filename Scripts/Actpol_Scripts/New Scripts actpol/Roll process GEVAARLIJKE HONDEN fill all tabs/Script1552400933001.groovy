...
WebUI.comment('GEVAARLIJKE HONDEN start')
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/GEVAARLIJKE HONDEN Achternaam'), 'petertje')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/A GEVAARLIJKE HONDEN/GEVAARLIJKE HONDEN Achternaam lb'))
