...
WebUI.comment('KENNISGEVER  start')
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/KENNISGEVER Achternaam'), 'DUQUE')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/A KENNISGEVER/KENNISGEVER Achternaam lb 2'))
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/A KENNISGEVER/KENNISGEVER Goederen Goed artikel lb 2'), FailureHandling.STOP_ON_FAILURE)
