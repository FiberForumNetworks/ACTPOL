...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/MENS IN NOOD Achternaam'), 'ABAD')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/A MENS IN NOOD/MENS IN NOOD Achternaam lb 2'))
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/A MENS IN NOOD/MENS IN NOOD Goederen Goed artikel lb 2'), FailureHandling.STOP_ON_FAILURE)
