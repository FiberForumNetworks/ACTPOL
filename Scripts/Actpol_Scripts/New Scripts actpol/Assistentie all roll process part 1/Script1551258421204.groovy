...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/Edit assit user 2'))
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/Proces Verbaal Nr'), '1234')
...
'EIGEN WAARNEMING'
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/Generiek/Assistentie/Rol Proces Type'), '51', false)

WebUI.waitForElementVisible(findTestObject('Actpol_Scripts/Extra script/Verbalisant 1'), 40)

WebUI.setText(findTestObject('Actpol_Scripts/Extra script/Verbalisant 1'), 'Dani')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/Verbalisant 1 lb'))
...
WebUI.setText(findTestObject('Actpol_Scripts/Extra script/Reden Getuige roll process new window'), 'BEDREIGING MET VUURWAPEN')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/Reden Getuige new window lb'))
...
WebUI.click(findTestObject('Actpol_Scripts/Extra script/Getuige roll process close'))

WebUI.delay(4)

'GEVAARLIJKE HONDEN'
WebUI.selectOptionByIndex(findTestObject('Actpol_Scripts/Generiek/Assistentie/Rol Proces Type'), '9', FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Actpol_Scripts/Extra script/GEVAARLIJKE HONDEN Achternaam'), 40)

WebUI.setText(findTestObject('Actpol_Scripts/Extra script/GEVAARLIJKE HONDEN Achternaam'), 'abdul')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Extra script/GEVAARLIJKE HONDEN Achternaam lb'))
...
WebUI.callTestCase(findTestCase('Actpol_Scripts/New Scripts actpol/Assistentie all roll process part 2'), [:], FailureHandling.STOP_ON_FAILURE)
