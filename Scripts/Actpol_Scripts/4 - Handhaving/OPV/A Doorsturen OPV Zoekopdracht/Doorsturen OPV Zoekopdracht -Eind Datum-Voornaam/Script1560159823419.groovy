...
not_run: WebUI.setText(findTestObject('Actpol_Scripts/Handhaving/OPV/A Doorsturen OPV Zoekopdracht/Achternaam'), 'O\'stiana')

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Handhaving/OPV/A Doorsturen OPV Zoekopdracht/Voornaam'), 'CLEOTIS')
