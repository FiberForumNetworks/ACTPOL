...
//WebUI.click(findTestObject('Actpol_Scripts/Handhaving/Patrouille/delete user'))
...
WebUI.focus(findTestObject('Actpol_Scripts/Handhaving/Patrouille/delete user 2'))
