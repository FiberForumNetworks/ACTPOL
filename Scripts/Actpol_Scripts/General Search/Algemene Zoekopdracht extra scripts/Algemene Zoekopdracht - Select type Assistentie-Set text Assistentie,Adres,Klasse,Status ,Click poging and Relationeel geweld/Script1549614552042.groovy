...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht -test env/Adres'), 'ANDRES BELLO WEG')
...
WebUI.click(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht -test env/Status Klasses 4 lb'))
...
WebUI.click(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht -test env/View Poging and geweld'), FailureHandling.OPTIONAL)

WebUI.delay(4, FailureHandling.OPTIONAL)

v = WebUI.getText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht -test env/Lokatie type poging and geweld'), 
