...
WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Geavanceerd Zoekopdracht Type'), 
    'entorganisatie', false)

WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Zoeken Text'), 'ADVOCATENKANTOOR LIEUW KIE SONG & LYNCH - AUTO WASSERIJEN')

WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Nauwkeurigheid'), '90', false)

not_run: WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Assistentie'), '200601146')

WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Onderzoek'), '237')
