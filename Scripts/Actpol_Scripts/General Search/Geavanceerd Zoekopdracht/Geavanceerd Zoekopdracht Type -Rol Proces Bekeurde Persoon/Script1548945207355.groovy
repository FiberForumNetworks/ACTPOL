...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Zoeken Text'), 'www')

WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Nauwkeurigheid'), '90', false)

WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Assistentie'), '200601778')
