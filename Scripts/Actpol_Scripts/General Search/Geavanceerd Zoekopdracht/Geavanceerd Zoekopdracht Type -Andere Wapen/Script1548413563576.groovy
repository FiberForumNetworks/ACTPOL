...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Zoeken Text'), 'INBESLAGGENOMEN BIJ FOUILLERING KLEDING')

WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Nauwkeurigheid'), '90', false)

not_run: WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Assistentie'), '200601578')

not_run: WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Onderzoek'), '0')
