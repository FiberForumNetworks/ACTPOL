...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Zoeken Text'), 'Computer - sdss sadsds')
...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Onderzoek'), '155')
