...
WebUI.setText(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Zoeken Text'), 'DREW')

WebUI.selectOptionByValue(findTestObject('Actpol_Scripts/General Search/Algemene Zoekopdracht/Nauwkeurigheid'), '90', false)

WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Assistentie'), '200601579')

WebUI.setText(findTestObject('Actpol_Scripts/General Search/Geavanceerd Zoekopdracht/Onderzoek'), '229')
