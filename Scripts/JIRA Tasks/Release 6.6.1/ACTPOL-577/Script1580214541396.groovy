...
WebUI.selectOptionByLabel(findTestObject('Actpol_Scripts/Info organisatie/a infodesk/Type'), 'Betrokkene', false)

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Info organisatie/a infodesk/Achternaam'), 'aa')
...
WebUI.setText(findTestObject('Actpol_Scripts/Info organisatie/a infodesk/Tel.nr'), '999999999')
...
String ambttextactula = WebUI.getText(findTestObject('Actpol_Scripts/Info organisatie/a infodesk/Ambtsverslag tab'))

key.logInfo(ambttextactula)

String textambtexpected = 'Ambtsverslag'

if (ambttextactula == textambtexpected) {
    key.markPassed(textambtexpected + 'is visible')
} else {
    key.markFailed(textambtexpected + 'is not visible')
}

WebUI.delay(1)

String jourttextactula = WebUI.getText(findTestObject('Actpol_Scripts/Info organisatie/a infodesk/Journaal tab'))

key.logInfo(jourttextactula)

String textjourexpected = 'Journaal'

if (jourttextactula == textjourexpected) {
    key.markPassed(textjourexpected + 'is visible')
} else {
    key.markFailed(textjourexpected + 'is not visible')
}
