...
'Enter the date'
WebUI.sendKeys(findTestObject('Actpol_Scripts/Opsporing/MBES18/1 Registratie/Datum'), '01012019')
...
not_run: WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/MBSC SAVE'), FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/5 INCIDENTEN/Datum Incident'), '29012019')
...
WebUI.sendKeys(findTestObject('Actpol_Scripts/Opsporing/MBES18/6 Overige gegevens/Datum vlucht'), '22082019')
...
WebUI.selectOptionByLabel(findTestObject('Actpol_Scripts/Opsporing/MBES18/6 Overige gegevens/Arrival location'), 'Luchthaven', 
    false)

WebUI.delay(1)

WebUI.sendKeys(findTestObject('Actpol_Scripts/Opsporing/MBES18/6 Overige gegevens/Datum'), '22082019')
...
WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/6 Overige gegevens/OVERIGE GEGEVENS tab'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/BEZITTINGEN_BAGAGE tab'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Geld ja'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bedrag en valuta text box'), 'Testing : Bedrag en valuta')

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bedrag en valuta auto text box'), 'a')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bedrag en valuta lb'))

WebUI.delay(4)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Pinpas_credict card ja'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bedrag maximale opname'), 'Testing : Bedrag en valuta')

WebUI.delay(1)

not_run: WebUI.selectOptionByLabel(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Arrival location'), 
    'Luchthaven', false)

WebUI.delay(1)

not_run: WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Datum'), '04/02/2019')

not_run: WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Datum img icon'))

not_run: WebUI.delay(1)

not_run: WebUI.selectOptionByLabel(findTestObject('Actpol_Scripts/Monthyear/Rightmonth'), 'aug', false)

not_run: WebUI.delay(1)

not_run: WebUI.selectOptionByLabel(findTestObject('Actpol_Scripts/Monthyear/Rightyear'), '2019', false)

not_run: WebUI.delay(1)

not_run: WebUI.click(findTestObject('Actpol_Scripts/Date/Right side/4th'))

not_run: WebUI.delay(3)

not_run: WebUI.selectOptionByIndex(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Vlucht'), '1')

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bestemming'), 'a')

WebUI.delay(2)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Bestemming lb'))

WebUI.delay(4)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Ingenomen n goederen ja'))

WebUI.delay(1)

WebUI.setText(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Toelichting(preciosa)'), 'Testing : Bedrag en valuta')

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Koffers ja'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Tasen ja'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Dozen'))

WebUI.delay(1)

WebUI.click(findTestObject('Actpol_Scripts/Opsporing/MBES18/7 BEZITTINGEN_BAGAGE/Reis ja'))
