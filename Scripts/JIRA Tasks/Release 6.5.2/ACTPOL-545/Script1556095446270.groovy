...
WebUI.scrollToElement(findTestObject('Actpol_Scripts/Extra script/AANGEVER Vaartuig'), 5)
...
WebUI.click(findTestObject('JIRA/A Relese 6.5.2/545 Vlag text area lb'))

WebUI.focus(findTestObject('Actpol_Scripts/Extra script/AANGEVER Vaartuig popup save'))
