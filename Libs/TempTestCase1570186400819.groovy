...
RunConfiguration.setExecutionSettingFile('C:\\Users\\user4\\AppData\\Local\\Temp\\Katalon\\Test Cases\\JIRA Tasks\\Release 6.5.1\\Navigation Generiek - assistentie - rol proces aangever. Also Opsporing - entiteiten - Persoon - aangever\\20191004_162316\\execution.properties')
...
'anu test 3'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Uitvoering 2'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Daderschap 2'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Juntu 2'), '1', FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.delay(2)

'anu test 3'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Uitvoering 3'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Daderschap 3'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Juntu 3'), '1', FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('JIRA/A NEW/Verdachte Info new/sf save'))

not_run: WebUI.delay(4)

not_run: WebUI.click(findTestObject('JIRA/A NEW/Verdachte Info new/total save'))
...
not_run: WebUI.click(findTestObject('JIRA/A NEW/Verdachte Info new/Achetemaam lb2'))

not_run: WebUI.delay(1)

'I.V.M. GIJZELING'
not_run: WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Reden'), '2', FailureHandling.STOP_ON_FAILURE)
...
'anu test 3'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Uitvoering 2'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Daderschap 2'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Juntu 2'), '1', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

'anu test 3'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Uitvoering 3'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Daderschap 3'), '1', FailureHandling.STOP_ON_FAILURE)

'new record'
WebUI.selectOptionByIndex(findTestObject('JIRA/A NEW/Verdachte Info new/Juntu 3'), '1', FailureHandling.STOP_ON_FAILURE)
