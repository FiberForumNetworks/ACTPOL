...
RunConfiguration.setExecutionSettingFile('C:\\Users\\user4\\AppData\\Local\\Temp\\Katalon\\Test Cases\\JIRA Tasks\\Release 6.6\\ACTPOL-552\\20190826_202408\\execution.properties')
...
not_run: Incidentnumber = WebUI.getText(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Incident number'))

not_run: WebUI.delay(1)

'Get text from the feild:: Adres van incident.'
not_run: avi = WebUI.getAttribute(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Adres van incident'), 'value')

not_run: WebUI.delay(1)

'Get text from the feild::Adres # van incident'
not_run: avi1 = WebUI.getAttribute(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Adres van Incident 1'), 'value')

not_run: WebUI.delay(1)

'Get text from the feild:: Incident'
not_run: Incidentca = WebUI.getText(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Incident calltaker'))

not_run: WebUI.delay(1)

'Get text from the feild:: Datum Melding'
not_run: DatumMeldingca = WebUI.getText(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Datum Meldingca'))

not_run: WebUI.delay(1)

'Get text from the feild:: Tijd Melding'
not_run: TijdMeldingca = WebUI.getText(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Tijd Melding ca'))

not_run: WebUI.delay(1)

'Get text from the feild:: Aangewezen aan'
not_run: Aangewezenaan1 = WebUI.getText(findTestObject('JIRA/A Relese 6.6/ACTPOL-552/Aangewezen aanca'))

not_run: WebUI.delay(1)

not_run: KeywordLogger log1 = new KeywordLogger()

not_run: log1.logInfo('Assistentie number is : ' + Incidentnumber)

not_run: log1.logInfo('Adres van incident : ' + avi)

not_run: log1.logInfo('Adres #van incident : ' + avi1)

not_run: log1.logInfo('Incident is: ' + Incidentca)

not_run: log1.logInfo('Datum Melding is : ' + DatumMeldingca)

not_run: log1.logInfo('Tijd Melding is : ' + TijdMeldingca)

not_run: log1.logInfo('Tijd Melding is : ' + Aangewezenaan1)

not_run: test1 = WebUI.concatenate('\\n', 'Incident number:' + Incidentnumber, '\\n', 'Adres van incident:' + avi, '\\n', 'Adres # van incident:' + 
    avi1, '\\n', 'Incident:' + Incidentca, '\\n', 'Datum Melding:' + DatumMeldingca, '\\n', 'Tijd Melding:' + TijdMeldingca, 
    '\\n', 'Aangewezen aan:' + Aangewezenaan1)

//println(test)
not_run: log1.logInfo(test1)
